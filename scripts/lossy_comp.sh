...
gdal_translate -a_srs EPSG:6539 -CO "COMPRESS=JPEG" -CO "PHOTOMETRIC=YCBCR" -CO "JPEG_QUALITY=85" -CO "TILED=YES" -b 1 -b 2 -b 3 -mask 4 "$result_folder"/final.vrt "$result_folder/${NAME}.tif"
